...
public class CreditCardScreen extends Screen {
    private static final ResourceLocation BackgroundTexture = new ResourceLocation("consume", "textures/gui/credit_card.png");
    ...
    void renderForeground(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawTexture(matrixStack, BankResources.BankLogoLocation, windowX + 13, windowY + 13, 128, 128, 128, 128);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawTexture(matrixStack, BackgroundTexture, windowX, windowY, xSize, ySize, 256, 256);
