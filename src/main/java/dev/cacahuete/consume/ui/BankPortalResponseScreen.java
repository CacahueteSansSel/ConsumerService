...
public class BankPortalResponseScreen extends Screen {
    ...
    public BankPortalResponseScreen(ServerToClientCryptoLoginResponsePacket packet) {
    ...
    public BankPortalResponseScreen(ServerToClientPaymentResponsePacket packet) {
        super(new TranslationTextComponent("ui.consume.crypto.recap.title"));
        isError = packet.isError;
    ...
    public BankPortalResponseScreen withFallbackScreen(Screen scr) {
        fallbackScreen = scr;
        return this;
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.minecraft.getTextureManager().bindTexture(isError ? BackgroundTextureNo : BackgroundTextureYes);
